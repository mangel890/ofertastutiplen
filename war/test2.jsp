...
<div class="votes"><img src="img/upArrow.png"
...
<div id="url"><a href="<%=request.getParameter("url")%>"> <%=request.getParameter("url")%>
</a></div>
...
<div id="bottomLineOffer">vista: <span id="bottomLineOfferValue"> <%=request.getParameter("clicks")%>
